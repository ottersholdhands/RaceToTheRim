...
{
    public class ScenPart_StartingDragon : ScenPart
    {
        ...
        public override void DoEditInterface(Listing_ScenEdit listing)
        {
            ...
            if (Widgets.ButtonText(scenPartRect.BottomHalf(), this.CurrentAnimalLabel().CapitalizeFirst(), true, true, true))
            {
                ...
                list.Add(new FloatMenuOption("RttR_RandomDragon".Translate().CapitalizeFirst(), delegate ()
                {
        ...
        private IEnumerable<PawnKindDef> PossibleAnimals(bool checkForTamer = true)
        {
            return from td in DefDatabase<PawnKindDef>.AllDefs
                   where td.RaceProps.Animal && (td.defName.Contains("RttR_"))
                   select td;
        }
        ...
        private string CurrentAnimalLabel()
        {
            ...
            {
                return "RttR_RandomDragon".TranslateSimple();
            }
        ...
        public override void Randomize()
        {
            ...
            this.count = PetCountChances.RandomElementByWeight((Pair<int, float> pa) => pa.Second).First;
            this.bondToRandomPlayerPawnChance = 0f;
        }

        public override bool TryMerge(ScenPart other)
        {
            ScenPart_StartingDragon scenPart_StartingAnimal = other as ScenPart_StartingDragon;
        ...
        public override IEnumerable<Thing> PlayerStartingThings()
        {
            ...
            for (int i = 0; i < this.count; i = num + 1)
            {
                ...
                {
                    kindDef = this.PossibleAnimals(false).RandomElement(); 
                ...
                if (animal.Name == null || animal.Name.Numerical)
                {
                    ...
                    Pawn pawn = (from p in Find.GameInitData.startingAndOptionalPawns.Take(Find.GameInitData.startingPawnCount)
                                 where !p.story.traits.HasTrait(TraitDefOf.Psychopath)
