    ...
    public class WeatherEvent_CustomLightningStrike : WeatherEvent_LightningFlash
    {
        ...
        public override void FireEvent()
        {
            ...
            if (!this.strikeLoc.Fogged(this.map))
            {
                ...
                GenExplosion.DoExplosion(this.strikeLoc, this.map, 1.9f, DamageDefOf.Flame, null, -1, -1f, null, null, null, null, null, 0f, 1,null, false, null, 0f, 1, 0f, false, null, ignoredThings);
