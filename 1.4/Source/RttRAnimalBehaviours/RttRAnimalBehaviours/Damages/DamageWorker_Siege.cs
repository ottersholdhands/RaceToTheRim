...
namespace RttRAnimalBehaviours
{
    ...
    public class DamageWorker_Siege : DamageWorker_AddInjury
    {
        ...
        public override DamageWorker.DamageResult Apply(DamageInfo dinfo, Thing victim)
        {
            ...
            if ((wall != null) && ((wall.def.building.isNaturalRock) || (wall.def == ThingDefOf.Wall) || (wall.def == ThingDefOf.Door)))
            {
                ...
                {
                    damageResult.totalDamageDealt = Mathf.Min((float)victim.HitPoints, dinfo.Amount * 10);
